 ...
 * @author Rivera
 */
public class FacePamphletNode {
    public boolean selected = false;
    public ArrayList<FacePamphletNode> connections = new ArrayList<>();
    ...
    public FacePamphletNode(String name, double x, double y) {
        this.name = name;
    ...
    public void connect(FacePamphletNode toConnect) {
        connections.add(toConnect);
        weights.add(1);
    }

    public void connect(FacePamphletNode toConnect, int weight) {
        connections.add(toConnect);
        weights.add(weight);
    }

    public void disconnect(FacePamphletNode toDisconnect) {
