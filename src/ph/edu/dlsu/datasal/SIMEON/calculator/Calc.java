 ...
 * @author student
 */
public class Calc extends GraphicsProgram {
    private String[] hay = new String[10000];
    private int index=0;
    private int nay;
    ...
    private void drawplus(){
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                hay[index]=input;
                index++;
                operand.push(Double.parseDouble(hay[index-1]));
                }
                input="+";
                cure = "+";
                operator.push(cure);
     ...
     private void drawequal(){
            ...
            add(equal,190-3*boxwidth,190);
             equal.setFillColor(Color.blue);
            equal.setFilled(true);
    ...
    private void drawminus(){
            ...
            add(minus,40,90);
            minus.setFillColor(Color.orange);
    ...
    private void plusminus(){
            ...
            plusminus.setFillColor(Color.blue);
            plusminus.setFilled(true);
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                double cure3=operand.top();
                operand.pop();
                operand.push(-cure3);
                double cure2=operand.top();
                input=String.valueOf(cure2);
                drawcure();
                input="";
            }
            @Override
    ...
    private void drawdivide(){
            ...
            add(divide,40,150);
            divide.setFillColor(Color.green);
    ...
    private void drawsix(){
      ...
      private void drawnine(){
            ...
            nine.setFillColor(Color.yellow);
            nine.setFilled(true);
      ...
      private void drawcancel(){
            ...
            cancel.setFillColor(Color.green);
            cancel.setFilled(true);
      ...
      private void drawtwo(){
        ...
        private void drawfive(){
            ...
            five.setFillColor(Color.orange);
            five.setFilled(true);
        ...
        private void draweight(){
            ...
            eight.setFillColor(Color.yellow);
            eight.setFilled(true);
        ...
        private void drawseven(){
            ...
            seven.setFillColor(Color.yellow);
            seven.setFilled(true);
    ...
    public void run(){
            ...
            answer.setFillColor(Color.pink);
