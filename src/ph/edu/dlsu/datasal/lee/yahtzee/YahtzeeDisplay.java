  ...
  implements YahtzeeDisplayConstants, ActionListener, MouseListener
{
  ...
  public void updateScorecard(int category, int player, int score)
  {
    ...
    this.scorecard[(player + 1)][0].setHighlighted(false);
    this.scorecard[(player + 1)][(category + 1)].setLabel(score+"");
  }
  ...
  public void mousePressed(MouseEvent e) {
    if ((this.mode != 3) || (!(e.getSource() instanceof GScorecardEntry))) return;
