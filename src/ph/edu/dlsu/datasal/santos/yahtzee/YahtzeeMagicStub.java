...
/*    */     }
/* 37 */     switch (category) {
/* 38 */     case 1:  return true;
/* 39 */     case 2:  return true;
/* 40 */     case 3:  return true;
/* 41 */     case 4:  return true;
/* 42 */     case 5:  return true;
/* 43 */     case 6:  return true;
/* 44 */     case 9:  return maxCount >= 3;
/* 45 */     case 10:  return maxCount >= 4;
/*    */     case 11: 
...
/* 60 */       return false;
/* 61 */     case 14:  return maxCount == 5;
/* 62 */     case 15:  return true; }
/* 63 */     throw new ErrorException("checkCategory: Illegal category");
/*    */   }
/*    */ }


/* Location:              C:\Users\Cellix\Documents\NetBeansProjects\Yahtzee\yahtzeelib.jar!\YahtzeeMagicStub.class
