...
public class NameSurferGraph1 extends GCanvas
	...
	private MyQ <NameSurferEntry> entriesDisplayed = new MyQ<NameSurferEntry>();
	
	public NameSurferGraph1() {
		addComponentListener(this);
		entriesDisplayed.createq();
	}
        ...
        private void showentry(){
            if(entriesDisplayed.size() > 0){
                    for(int i=0; i<entriesDisplayed.size();i++){
                            NameSurferEntry entries = entriesDisplayed.item(i); 
                            drawEntry(entries, i);
                    }
            }
        }
