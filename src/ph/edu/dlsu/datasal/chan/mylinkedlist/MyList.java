package ph.edu.dlsu.datasal.chan.mylinkedlist;


import java.util.Collection;
import ph.edu.dlsu.datasal.chan.myinterface.List;
import ph.edu.dlsu.datasal.chan.myexception.ListIndexOutOfBoundsException;


public class MyList<E> implements List<E>{//1-based
    ...
    public boolean removeAll(MyList<E> c){
    ...
    public MyList<E> intersection(MyList<E> comp){
        MyList<E> ans=new MyList<>();
        for(Node<E> cur=head;cur!=null;cur=cur.getNext()){
            E item=cur.getItem();
