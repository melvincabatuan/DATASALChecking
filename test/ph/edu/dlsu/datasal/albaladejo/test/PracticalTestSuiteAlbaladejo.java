...
public class PracticalTestSuiteAlbaladejo {
    
  private static final Logger LOG = Logger.getLogger(PracticalTestSuiteAlbaladejo.class.getName());

  @BeforeClass
  public static void setupBeforeSuiteRuns() {
    LOG.info("START: Testing Albaladejo's CP12 Practical...");
  }
