...
public class PracticalTestSuiteSimeon {
    
  private static final Logger LOG = Logger.getLogger(PracticalTestSuiteSimeon.class.getName());

  @BeforeClass
  public static void setupBeforeSuiteRuns() {
    LOG.info("START: Testing Simeon's CP12 Practical...");
  }
