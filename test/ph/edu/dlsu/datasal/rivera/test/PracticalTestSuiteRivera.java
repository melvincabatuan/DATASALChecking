...
public class PracticalTestSuiteRivera {
    
  private static final Logger LOG = Logger.getLogger(PracticalTestSuiteRivera.class.getName());

  @BeforeClass
  public static void setupBeforeSuiteRuns() {
    LOG.info("START: Testing M. Rivera's CP12 Practical...");
  }
