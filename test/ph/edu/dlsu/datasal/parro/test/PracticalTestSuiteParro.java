...
public class PracticalTestSuiteParro {
    
  private static final Logger LOG = Logger.getLogger(PracticalTestSuiteParro.class.getName());

  @BeforeClass
  public static void setupBeforeSuiteRuns() {
    LOG.info("START: Testing Parro's CP12 Practical...");
  }
