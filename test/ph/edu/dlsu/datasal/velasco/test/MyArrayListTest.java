...
import ph.edu.dlsu.velasco.myarraylist.MyList;
import ph.edu.dlsu.velasco.myarraylist.MyListInteger;
import ph.edu.dlsu.velasco.myexception.ListIndexOutOfBoundsException;
...
public class MyArrayListTest {
    ...
    public void sortTest() {
        MyListInteger intList = new MyListInteger();
        intList.add(1,1);
        intList.add(2,5);
        intList.add(3,2);
        intList.add(4,4);
