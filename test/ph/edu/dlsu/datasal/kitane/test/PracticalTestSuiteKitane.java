...
public class PracticalTestSuiteKitane {
    
  private static final Logger LOG = Logger.getLogger(PracticalTestSuiteKitane.class.getName());

  @BeforeClass
  public static void setupBeforeSuiteRuns() {
    LOG.info("START: Testing Kitane's CP12 Practical...");
  }
