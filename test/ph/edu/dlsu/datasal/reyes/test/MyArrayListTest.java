...
import ph.edu.dlsu.datasal.reyes.datasalapp.mylist.MyArrayList;
import ph.edu.dlsu.datasal.reyes.datasalapp.myexceptions.ListIndexOutOfBoundsException;
...
public class MyArrayListTest {
    ...
    public void intersectionTest() {
        ...
        sample.add(2, "Beta");
        sample.add(3, "Gamma");
        assertTrue(list.equals(list.intersection(sample)));
        assertTrue(list.equals(sample.intersection(list)));
        assertTrue(list.equals(list.intersection(list)));
    }
