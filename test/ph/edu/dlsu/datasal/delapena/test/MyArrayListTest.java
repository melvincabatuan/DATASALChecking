...
import ph.edu.dlsu.datasal.DELA_PENA.MyException.ListIndexOutOfBoundsException;
...
//        assertTrue(list.size() == sample.size());
//        assertEquals(list.get(1), sample.get(1));
//        assertEquals(list.get(2), sample.get(2));
