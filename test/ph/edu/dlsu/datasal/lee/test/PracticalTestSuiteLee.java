...
public class PracticalTestSuiteLee {
    
  private static final Logger LOG = Logger.getLogger(PracticalTestSuiteLee.class.getName());

  @BeforeClass
  public static void setupBeforeSuiteRuns() {
    LOG.info("START: Testing Lee's CP12 Practical...");
  }
