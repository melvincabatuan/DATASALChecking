...
public class PracticalTestSuiteGo {
    
  private static final Logger LOG = Logger.getLogger(PracticalTestSuiteGo.class.getName());

  @BeforeClass
  public static void setupBeforeSuiteRuns() {
    LOG.info("START: Testing Go's CP12 Practical...");
  }
