...
public class PracticalTestSuiteAng {
    
  private static final Logger LOG = Logger.getLogger(PracticalTestSuiteAng.class.getName());

  @BeforeClass
  public static void setupBeforeSuiteRuns() {
    LOG.info("START: Testing R. Ang's CP12 Practical...");
  }
